<template>
   <div id="About">
         <div class="about_1_bg">
              <div class="about_top">
                <h1 class="main_h1">广东鸿特信息咨询有限公司</h1>
              ...
              <div class="about_1_block">
                  <h1>公司简介</h1>
                  <article class="article_text">公司致力于通过大数据、人工智能、互联网科技等技术力量为企业及个人提供高效、专业的，<b>集金融信息咨询、信用风险管理、信用数据</b>整合于一体的信息服务。截至目前，公司在全国主要城市拥有200余家分、子公司，员工近5000人。鸿特信息始终坚持科技创新、金融创新和服务创新三大维度的核心竞争力，以打造最具竞争力、价值感的创新型金融信息咨询服务平台。鸿特信息将以至诚的态度服务市场，精确把握金融科技发展带来的行业契机，打造综合金融信息咨询服务产品矩阵，为广大客户及合作机构提供更专业的金融信息咨询、企业管理咨询等服务。</article>
              </div>
         </div>
   </div>
</template>
...
.about_1_block {
    ...
    padding:pxToRem(68px) pxToRem(50px) pxToRem(87px) pxToRem(50px);
