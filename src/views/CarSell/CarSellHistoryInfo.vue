<template>
    <div class="CarSellInfo" v-if="d">
            ...
            <div class="CarSellInfo__navbar" :class="{'an-ing': !d.isFinish}" v-if="d.priceCount !== 0">
                 ...
                 <div class="CarSellInfo__navbarright" v-if="d.isFinish">交易价：¥{{ d.transPrice }}</div>
            </div>
            ...
            <div class="subject">
               ...
               <div class="subject__item" v-if="!d.isFinish">
                   <div class="leftitem">
               ...
               <div class="carRule__rows mt38" v-if="!d.isFinish">
                   <div class="carRule__rowsleft">交易税费：</div>
                   <div class="carRule__rowsright">{{ d.taxation }}</div>
               </div>
               <div class="carRule__rows" v-if="!d.isFinish">
               ...
               <div class="subject__last" v-if="!d.isFinish">
            ...
            <div class="buyneedknow" v-if="!d.isFinish">
            ...
            <!--我的报价记录-->
            <div class="quotation__record">
                <div class="subject__title">我的报价记录</div>
                <div class="aq-item">
                    <div class="aq-lt">出价16,000元</div>
                    <div class="aq-rl">2018/02/23 14:50:29</div>
                </div>
                <div class="aq-item">
                    <div class="aq-lt">出价16,000元</div>
                    <div class="aq-rl">2018/02/23 14:50:29</div>
            ...
            <div class="btnblock">
                <button class="btn btn--primary" @click="go" v-if="d.priceCount !== 3 || !d.isFinish">我要竞买</button>
            </div>
        </div>
    </div>
</template>
