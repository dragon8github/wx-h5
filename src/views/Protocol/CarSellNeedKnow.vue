<template>
    <div class="CarSellProtocol">
        <div class="buyneedknow">
                ...
                <div>
                    <p>我方将于XXXX年XX月X日X时至XXXX年XX月X日X时止（延时的除外）进行公开竞买活动，现就有关的竞买事宜敬告各位竞买人：</p>
                    ...
                    <p>五、竞买活动结束后，竞买成功的竞买人应于XXXX年XX月X日X时前将竞买成交价余款（扣除保证金后的余款）缴纳完毕，并凭相关证件自行前往指定地点接收车辆。</p>
                    ...
                    <p>咨询电话: <br>联系地址：</p>
                    <p class="buyneedknow--right">xxxx年xx月xx日</p>
                </div>
        </div>
    </div>
</template>
