    ...
    <div class="CarSellNotice">
        <div class="Notice">
                ...
                <div>
                    ...
                    <p><span class="Notice--bold">我方将于X年X月X日X时至X年X月X日X时止进行公开竞买活动，</span> 现公告如下：</p>
                    <p class="Notice--indent">一、 竞买标的： 车牌号： XXX； 车辆型号： XXX； 车辆识别代号： XXX； 发动机号： XXX； 初次登记日期： X年X月X日； 行驶总里程： XXXKM。</p>
                    ...
                    <p class="Notice--indent"><span class="Notice--bold">三、 咨询、 集中展示看样的时间与方式： 自X年X月X日起至X年X月X日X时止接受咨询（ 双休日、 节假日除外）。 有意看样者请于XXXX年XX月XX日XX时前到达以下地点进行看样。</span></p>
                    <p>集中看样地点：</p>
                    ...
                    <p class="Notice--indent"> <span class="Notice--bold">六、 本标的物竞得者应将竞买款在X年X月X日X时前缴入我方指定账户(户名： XX开户银行： XX账号： XXX)。</span></p>
